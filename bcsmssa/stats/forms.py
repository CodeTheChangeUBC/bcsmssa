...
from django.forms import CheckboxSelectMultiple                         #Added
from stats.models import Client, ServicesRequested, ReferredBy          #Added
...
class ReferredByForm(BootstrapModelForm):
    ...
    other2 = forms.CharField(max_length=30, required=False, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'please specify'}))
